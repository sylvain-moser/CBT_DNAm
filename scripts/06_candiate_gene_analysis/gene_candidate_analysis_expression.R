...
genes_of_interest=candidates$Gene_Symbol
...
cpgs_of_interest=as.vector(annotations_df %>% filter (GeneSymbol %in% genes_of_interest) %>% pull (island))
cpgs_of_interest=c(cpgs_of_interest)

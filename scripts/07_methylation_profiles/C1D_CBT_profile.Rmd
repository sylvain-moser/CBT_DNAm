---
title: "C1D_methylation_CBT_profile"
...
# cg01848660 from the therapy analysis
...
```{r}
time_df=meth_residuals %>% select(NID,Timepoint,cg01848660) %>% filter (NID %in% intersect(exposure_ID,therapy_ID)) %>% 
...
plot_C1D_CBT=ggplot(time_df,aes(x=Time,y=cg01848660,group=NID,colour=NID))+geom_line()+
  scale_x_continuous(name="Timepoints",breaks=c(0,1,2,3,4,5,6),labels=c("T0","T4","BE","PE1h","PE24h","E","K"))+
  labs(title = "cg01848660",y="residuals methyl.")+
...
plot_C1D_postint=ggplot(time_df,aes(x=Time,y=cg01848660,group=NID,colour=NID))+geom_line()+
...
plot_C1D_postint_remission=ggplot(remission_df,aes(x=Time,y=cg01848660,group=NID,colour=as.factor(remission)))+geom_line()+
  scale_x_continuous(name="Timepoints",breaks=c(0,1,2,3),labels=c("T0","T4","E","K"))+
  labs(title = "C1D",y="residuals methyl.",colour="remission")+
...
plot_C1D_postint_remission
```

### color coded for the response status: 

```{r}
plot_C1D_postint_response=ggplot(remission_df,aes(x=Time,y=cg01848660,group=NID,colour=as.factor(response)))+geom_line()+
  scale_x_continuous(name="Timepoints",breaks=c(0,1,2,3,4),labels=c("BE","PE1h","PE24h","E","K"))+
  labs(title = "C1D",y="residuals methyl.",colour="response")+
  theme(plot.title = element_text(hjust = 0.5),panel.background = element_blank(),text = element_text(size = 30),axis.ticks=element_blank(),legend.title=element_text(size = 20),legend.text = element_text(size = 20),axis.line = element_line(colour ="darkgrey"))+
  stat_summary(fun=mean,geom="line",lwd=2,aes(group=as.factor(response)))
plot_C1D_postint_response
```
...
plot_C1D_CBT_residuals_remission=ggplot(remission_df,aes(x=Time,y=cg01848660,group=NID,colour=as.factor(remission)))+geom_line()+
  scale_x_continuous(name="Timepoints",breaks=c(0,1,2,3,4,5,6),labels=c("T0","T4","BE","PE1h","PE24h","E","K"))+
  labs(title = "C1D",y="residuals methyl.",colour="remission")+
  theme(plot.title = element_text(hjust = 0.5),panel.background = element_blank(),text = element_text(size = 30),axis.ticks=element_blank(),legend.title=element_text(size = 20),legend.text = element_text(size = 20),axis.line = element_line(colour ="darkgrey"))+
  stat_summary(fun=mean,geom="line",lwd=2,aes(group=as.factor(remission)))
plot_C1D_CBT_residuals_remission
```

### color coded for the response status: 

```{r}
plot_C1D_CBT_residuals_response=ggplot(remission_df,aes(x=Time,y=cg01848660,group=NID,colour=as.factor(response)))+geom_line()+
  scale_x_continuous(name="Timepoints",breaks=c(0,1,2,3,4,5,6),labels=c("T0","T4","BE","PE1h","PE24h","E","K"))+
  labs(title = "C1D",y="residuals methyl.",colour="response")+
  theme(plot.title = element_text(hjust = 0.5),panel.background = element_blank(),text = element_text(size = 30),axis.ticks=element_blank(),legend.title=element_text(size = 20),legend.text = element_text(size = 20),axis.line = element_line(colour ="darkgrey"))+
  stat_summary(fun=mean,geom="line",lwd=2,aes(group=as.factor(response)))
  plot_C1D_CBT_residuals_response
```
